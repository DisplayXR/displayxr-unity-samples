...
REM (BIN_DIR = Builds\Win64\DisplayXR-HDRP-SinglePass-UI, exe = DisplayXR-HDRP-SinglePass-UI.exe).
set "OUT_DIR=%PROJECT_PATH%\Builds\Win64\DisplayXR-HDRP-SinglePass-UI"
set "OUT_EXE=%OUT_DIR%\DisplayXR-HDRP-SinglePass-UI.exe"
