...
REM (BIN_DIR = Builds\Win64\DisplayXR-URP-SinglePass-UI, exe = DisplayXR-URP-SinglePass-UI.exe).
set "OUT_DIR=%PROJECT_PATH%\Builds\Win64\DisplayXR-URP-SinglePass-UI"
set "OUT_EXE=%OUT_DIR%\DisplayXR-URP-SinglePass-UI.exe"
